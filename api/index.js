...
import categoryRoutes from './src/routes/categoryRoutes.js';
import userRoutes from './src/routes/userRoutes.js';
import visitRoutes from './src/routes/visitRoutes.js'; // ADD THIS LINE
...
app.get('/', (req, res) => {
  res.json({
    ...
    endpoints: {
      ...
      reviews: '/api/reviews',
      favorites: '/api/favorites',
      visits: '/api/visits', // ADD THIS LINE
      categories: '/api/categories',
      health: '/api/ping'
    }
  });
...
app.use('/api/reviews', reviewRoutes); // Reviews and ratings
app.use('/api/favorites', favoriteRoutes); // User favorites
app.use('/api/visits', visitRoutes); // ADD THIS LINE - User visits/food journey
app.use('/api/users', userRoutes);
app.use('/api/categories', categoryRoutes); // Coffee shop categories
...
const server = app.listen(PORT, () => {
  ...
  console.log('  • GET  /api/reviews - Get Reviews');
  console.log('  • GET  /api/favorites - Get Favorites');
  console.log('  • GET  /api/visits - Get Visits'); // ADD THIS LINE
  console.log('  • GET  /api/categories - Get Categories');
  console.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
